...
public struct Vertex
{
    public static readonly InputElementDescription[] VertexInputLayout =
        Triangles.Renderer.VertexInputLayout.GetVertexLayout(VertexType.Position, VertexType.Color3, VertexType.Uv);
...
public struct VertexInputLayout
{
    ...
    public static InputElementDescription[] GetVertexLayout(params VertexType[] elements)
    {
